  ...
  return (
    <div className="min-h-screen bg-white flex flex-col p-6 md:p-10">
      <div className="max-w-4xl w-full mx-auto">
        ...
        {/* Navy blue header card */}
        <div className="rounded-2xl bg-[#142042] p-8 mb-8 shadow-lg text-center">
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Create Flashcards
          </h1>
          <p className="text-[#b3c6e0] max-w-2xl mx-auto">
        ...
        {/* Outer blue box with outline */}
        <div className="fanar-blue-box p-6 md:p-10 mb-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {/* Left Column - Main Content */}
            <div className="lg:col-span-2 space-y-6">
              {/* Material Info - Now at the top */}
              <Card className="bg-[#eaf0fa]">
                <CardHeader>
                  <CardTitle className="flex items-center text-[#223366]">
                    <FileText className="h-5 w-5 mr-2 text-[#223366]" />
                    Material Info
                  </CardTitle>
                  <CardDescription className="text-[#475569]">Source material details</CardDescription>
                </CardHeader>
                      ...
                      <div className="mt-2 space-y-1 text-sm">
                        {material.fileName && (
                          <div className="flex items-center">
                            <File className="h-3 w-3 text-[#223366] mr-1.5" />
                            <span className="text-[#475569] text-xs truncate max-w-xs">
                              {material.fileName}
                            </span>
                          </div>
                        )}
                        {material.type && (
                          <div className="flex items-center">
                            <FileText className="h-3 w-3 text-[#223366] mr-1.5" />
                        ...
                        {material.createdAt && (
                          <div className="flex items-center">
                            <Clock className="h-3 w-3 text-[#223366] mr-1.5" />
                            <span className="text-[#475569] text-xs">
              ...
              <Card className="bg-[#eaf0fa]">
                <CardHeader>
                  <CardTitle className="flex items-center text-[#223366]">
                    <Settings className="h-5 w-5 mr-2 text-[#223366]" />
                    Flashcard Settings
                  </CardTitle>
                  <CardDescription className="text-[#475569]">Customize your flashcards</CardDescription>
                </CardHeader>
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      {[5, 10, 15, 20, 30].map((value) => (
                        <Button
                          ...
                          className={
                            flashcardParams.numFlashcards === value
                              ? "bg-gradient-to-r from-[#223366] to-[#4f6fae] text-white no-loading"
                              : "border-[#223366] text-[#223366] no-loading hover:bg-[#eaf0fa]"
                          }
                          onClick={() =>
                ...
                <CardFooter className="flex justify-end border-t pt-6">
                  {generatedDeckId ? (
                    ...
                    <Button
                      className="bg-gradient-to-r from-[#223366] to-[#4f6fae] text-white no-loading font-bold"
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <Card className="bg-[#eaf0fa]">
                <CardHeader className="pb-2">
                  <CardTitle className="text-base flex items-center text-[#223366]">
                    <Clipboard className="h-4 w-4 mr-2 text-[#223366]" />
                    About Flashcards
                  </CardTitle>
                </CardHeader>
                <CardContent>
              ...
              {generating && (
                <Card className="bg-[#eaf0fa] border-[#223366]/20 shadow-sm">
                  <CardContent className="p-6">
                    <div className="flex flex-col items-center text-center">
                      <Loader className="h-12 w-12 text-[#223366] animate-spin mb-4" />
                      ...
                      <div className="w-full mb-3">
                        <div className="flex justify-between text-xs text-[#223366] mb-1">
                          <span>Progress</span>
                      ...
                      {estimatedTime && startTime && (
                        <div className="text-xs text-[#223366] mb-2">
                          <div>
                      ...
                      {(flashcardParams.generateImages ||
                        ...
                        <div className="mt-3 space-y-2">
                          {flashcardParams.generateImages && (
                            <div className="p-2 bg-[#d3e0f7] rounded-lg">
                              <p className="text-xs text-[#223366]">
                          ...
                          {flashcardParams.generateImages &&
                            flashcardParams.translateToArabic && (
                              <div className="p-2 bg-[#b3c6e0] rounded-lg">
                                <p className="text-xs text-[#142042]">
              ...
              <Card className="bg-[#eaf0fa]">
                <CardContent className="p-4">
                  <div className="flex items-start">
                    <HelpCircle className="h-5 w-5 text-[#223366] mr-2 mt-0.5" />
                    <div>
